...
<article id="post-<?php the_ID(); ?>" <?php post_class('post-items mb-4'); ?>>
	<figure class="post-image">
		...
		<?php if(!is_single()): ?>	
			<a href="<?php echo esc_url(get_permalink()); ?>" class="post-hover"><i class="fa fa-share"></i></a>
		<?php endif; ?>
		...
		<div class="post-meta">
			...
			<?php if(has_tag()){ ?>
				<span class="post-tag">
					<a href="<?php esc_url(get_permalink()); ?>"><i class="fa fa-folder-open-o"></i></a><a href="<?php esc_url(get_permalink()); ?>" rel="category tag"><?php the_tags(''); ?></a>
				</span>
			<?php } ?>	
		</div>
	</figure>
